...
#+RESULTS:
| ol-doi | ol-w3m | ol-bbdb | ol-bibtex | ol-docview | ol-gnus | ol-info | ol-irc | ol-mhe | ol-rmail | ol-eww | org-habit | org-id |
...
#+RESULTS:
| org-indent-mode | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-fold-show-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes |
...
#+RESULTS:
| (lambda nil (interactive) (olivetti-mode) (olivetti-set-width 100)) | org-autolist-mode | org-fragtog-mode | org-appear-mode | org-superstar-mode | org-variable-pitch--enable | org-indent-mode | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-fold-show-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes |
...
*** Icons
 ...
 #+RESULTS:
 | (lambda nil (interactive) (setq prettify-symbols-alist '(([#A] . ) ([#B] . ) ([#C] . ) ([ ] . ) ([X] . ) ([-] . ) (#+begin_src . ) (#+end_src . ―) (#+begin_collapsible . ) (#+end_collapsible . ―) (#+begin_aside . ) (#+end_aside . ―) (#+begin_quote . ) (#+end_quote . ―) (#+begin_defn . ) (#+end_defn . ―) (#+begin_questionable . ) (#+end_questionable . ―) (#+begin_problem . ) (#+end_problem . ―) (#+EXCLUDE_TAGS: . ) (:PROPERTIES: . |

*** COMMENT Property Drawers
#+begin_src emacs-lisp :tangle "yes"
...
#+RESULTS:
| (lambda nil (org-cycle-hide-drawers 'all)) | (lambda nil (interactive) (setq prettify-symbols-alist '(([#A] . ) ([#B] . ) ([#C] . ) ([ ] . ) ([X] . ) ([-] . ) (#+begin_src . ) (#+end_src . ―) (#+begin_collapsible . ) (#+end_collapsible . ―) (#+begin_aside . ) (#+end_aside . ―) (#+begin_quote . ) (#+end_quote . ―) (#+begin_defn . ) (#+end_defn . ―) (#+begin_questionable . ) (#+end_questionable . ―) (#+begin_problem . ) (#+end_problem . ―) (#+EXCLUDE_TAGS: . ) (:PROPERTIES: . |
...
** COMMENT Export
  #+begin_src emacs-lisp :tangle "yes"
    (use-package org-special-block-extras
      ...
      ;; (org-defblock theorem (title nil) (contents "")
      ;;                (format
      ;;                 (pcase backend
      ;;                   (_ "\\begin{theorem}
      ;;                        %s
...
#+begin_src emacs-lisp :tangle "yes"
  (use-package vterm)
  (load-org-babel "~/.emacs.d/modules/intro.org") 
#+end_src
